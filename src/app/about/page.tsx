  ...
  return (
    <div>
      ...
      <div className="w-full h-auto flex flex-col md:flex-row justify-between items-center px-4 md:px-16 py-8">
        <div className="md:w-2/4 text-xl md:text-2xl text-center md:text-left lg:ml-16 text-custom-purple">
      ...
      {/* Story Section */}
      <div className="flex flex-col md:flex-row w-full h-auto items-center justify-center px-20 py-16 gap-4">
        <div className="w-full md:w-2/5">
          <img src="/Text Block.png" alt="about main" className="w-full" />
        </div>
        <div className="w-full md:w-2/5">
          <img
            src="/image-1.png"
      ...
      <div className="flex flex-col md:flex-row w-full h-auto items-stretch px-4 py-16 space-y-8 md:space-y-0">
        <img
          src="/image-2.png"
          alt="Service"
          className="w-full md:w-2/5 h-full transition-transform duration-300 ease-in-out hover:scale-105 hover:translate-y-1"
        />
