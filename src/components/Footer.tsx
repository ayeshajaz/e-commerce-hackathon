    ...
    <>
      <div className='px-6 md:px-12 py-8 bg-[#2A254B] mt-10'>
        <div className="flex flex-wrap justify-evenly gap-12 md:gap-[100px] lg:gap-[200px]">
          ...
          <div className="text-white w-full sm:w-auto flex flex-col justify-end">
            <h1 className="text-lg md:text-xl font-bold">Join our mailing list</h1>
            <div className='mt-4 text-white'>
              <input
                type="text"
                placeholder="your@email.com"
                className='w-full sm:w-[250px] lg:w-[300px] h-[48px] p-4 text-white border border-white rounded-md'
              />
              <button className='mt-2 sm:mt-0 sm:ml-2 w-full sm:w-[100px] h-[48px] text-[#FFFFFF] bg-gray-500 rounded-md'>
                Sign up
              </button>
            </div>
          </div>
